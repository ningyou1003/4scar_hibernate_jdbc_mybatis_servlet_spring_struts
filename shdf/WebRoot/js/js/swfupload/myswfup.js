        ...
        if (json.status == 001) {
            ...
            if (len > 0) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    strHtml += "<li><a href=" + p[i].url + " class='attlistC'>" + p[i].name + "</a>&nbsp;&nbsp;<a target=\"_blank\" href=" + p[i].url + " >下载</a>&nbsp;&nbsp;<a onclick=delattList('" + p[i].keyid + "') class='attlistC' style=\"cursor: pointer;\">删除</a></li>";
                }
