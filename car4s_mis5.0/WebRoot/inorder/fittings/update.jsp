...
<body>
    <form action="${_cxt}/fitInorder_update.do" method="post">
     <!-- 隐藏域 用于判断是不是提交表单-->
     <s:hidden name="commit" value="true"/>
     <%-- 隐藏域 待更新记录的ID--%>
     <s:hidden name="fitInorder.id"/>
    <table class="tbform list">
          <thead onclick="collapse(this);">
            <tr class="tr">
              <th colspan="4" style="text-align: left;">
                                         配件进货单更新<i class="tip-up"></i>
              </th>
            </tr>
          </thead>
          <tbody>
         <tr>
           ...
           <td align="left">
             <s:hidden id="fitId" name="fitInorder.fittingsId"/>
             <s:textfield cssClass="ipt" id="fitName" readonly="true"
                          value="%{fitInorder.fitName}"/>
             <!-- 弹出列表链接 -->
         ...
         <tr>
           ...
           <td align="left">
             <s:textfield cssClass="ipt" name="fitInorder.count"/>  
           </td>
           <td align="right">进货价(元):</td>
           <td align="left">
             <s:textfield cssClass="ipt" name="fitInorder.inPrice"/>           
           </td>
         </tr>
         <tr>
           <td align="right">备注:</td>
           <td align="left" colspan="3">
             <s:textarea name="fitInorder.remark" cols="105"/>
           </td>
         </tr>
         <tr>
            <td colspan="2"></td>
