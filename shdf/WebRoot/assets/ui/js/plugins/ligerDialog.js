...
(function ($) {
    ...
    $.ligerDefaults.Dialog = {
        ...
        isRefresh: false             //false不刷新父类true刷新
    };
    ...
    l.controls.Dialog.ligerExtend(l.core.Win, {
        ...
        _render: function () {
            ...
            $(".l-dialog-tc .l-dialog-close", g.dialog).click(function () {
                if (p.isHidden) {
                    if (p.isRefresh) { //刷新Defaulf页面
                        //$("#content")[0].contentWindow.rightFrame.location.reload();//没有选项卡的刷新
                        $("#content")[0].contentWindow.rightFrame.AddItems("home", "Default.aspx"); //刷新home选项卡
                    }
                    g.hide();
                }
                else {
