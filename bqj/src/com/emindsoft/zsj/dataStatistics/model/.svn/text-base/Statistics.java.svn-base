...
@TableBind(tableName = "t_statistics", pkName = "KeyID")
public class Statistics extends BaseModel<Statistics> {
	
	public static Statistics dao = new Statistics();
	public static String table = "t_statistics";
	 ...
	 * @return
	 */
	public Page<Statistics> page(int pageNo,int pageSize,String SelectTitle,String selectRegionId) {
