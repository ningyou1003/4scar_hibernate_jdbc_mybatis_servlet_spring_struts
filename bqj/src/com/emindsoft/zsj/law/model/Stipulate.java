...
@TableBind(tableName = "l_stipulate", pkName = "keyID" )
public class Stipulate extends BaseModel<Stipulate> {
	public static Stipulate dao = new Stipulate();
	public static String table = "l_stipulate";
	 ...
	 * @return
	 */
	public Page<Stipulate> page(int pageNo,int pageSize,String SelecTitle,String selectRegionId) {
	 ...
	 * @return
	 */
	public Page<Stipulate> page(int pageNo,int pageSize) {
	 ...
	 * @return
	 */
	public Page<Stipulate> page(int pageNo,int pageSize,String regioncode) {
		return this.paginate(pageNo, pageSize, "select *,"
				+"(select relaName from s_user where keyid = userId) as user ",
