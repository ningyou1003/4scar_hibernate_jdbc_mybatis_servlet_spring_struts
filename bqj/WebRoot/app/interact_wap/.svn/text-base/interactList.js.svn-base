        ...
        Public.ajaxPost(Public.rootPath() + '/interact/post/getMostReplyPost', {
            ...
            if (json.status == 001) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    html += '<p class="txt">';
                    html += '<a href="Myinteract.html?userId=' + userid + '" target="_self">' + username + ' : <span class="txtcontent">' + content + '</span></p></a>';
        ...
        Public.ajaxPost(Public.rootPath() + '/interact/post/postList', {
            ...
            if (json.status == 001) {
                ...
                for (i = 0; i < len; i++) {
                    ...
                    html += '<div class="tweet">';
                    html += '';
                    html += ' <h3><a href="interactDetail.html?keyid=' + vm.data[i].id + '" target="_self" style="font-size:12px"><span class="txtcontent">' + content + '</span></a></h3><p class="txt"> </p>';
                    html += '<p class="outline">';
                    html += '<a href="Myinteract.html?userId=' + userid + '" target="_self">' + username + '</a> 发布于 ' + createtime + ' (<a href="interactDetail.html?keyid=' + vm.data[i].id + '" target="_self" style="font-size:12px">' + hasreply + '评</a>)';
                    html += '<!--添加点赞功能 Start-->';
                ...
                Public.ajaxPost(Public.rootPath() + '/interact/post/postList', {
                    ...
                    if (json.status == 001) {
                        ...
                        for (i = 0; i < len; i++) {
                            ...
                            html += '<div class="tweet">';
                            html += '<p class="txt">';
                            html += '<a href="Myinteract.html?userId=' + userid + '" target="_self">' + username + ' : <span class="txtcontent">' + content + '</span></a></p>';
                            html += '<p class="outline">';
