...
@TableBind(tableName = "s_job_user_parttime", pkName = "KeyId")
public class JobUserParttime extends BaseModel<JobUserParttime> {

	public static JobUserParttime dao = new JobUserParttime();
	public static String table = "s_job_user_parttime";
	...
	public void save(String uid, String jobsid) {
		...
		for (String rid : ids) {
			JobUserParttime ju = new JobUserParttime();
			ju.set("jobid", rid);
			ju.set("userid", uid);
			ju.set("KeyID", getId());
			ju.save();
