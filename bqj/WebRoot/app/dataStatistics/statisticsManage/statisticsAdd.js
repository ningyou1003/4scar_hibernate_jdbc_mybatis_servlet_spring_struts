...
THISPAGE = {
	...
	initData : function() {
		...
		if (request.queryString["keyid"] != null
			...
			saveData = true;
			Public.ajaxPost(Public.rootPath() + "/statistics/editData", "keyId="
...
//	vm.data.content = kindeditor.html();
	if(vm.data.keyid != "" && vm.data.keyid != null&& vm.data.keyid !=undefined){
		url= Public.rootPath() + "/statistics/edit";
	}else{
		url= Public.rootPath() + "/statistics/add";
	}
...
//	KE();
	THISPAGE.init();
	initUpload("statistics", vm.data.keyid);
